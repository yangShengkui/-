   ...
   var url1="http://192.168.1.201:9000/inspection/";
   
   var url2="http://192.168.1.201:9000/usermanage/";
   ...
   function showHtmlRight(url,datas){
       ...
       $.ajax({
           ...
           error:function(xhr,textStatus){
               ...
               var code=xhr.status;
               if(code==222){
                   window.location.href="../../again_login.html";
               }else{
                   window.location.href="../../abnormal_login.html";
               }
